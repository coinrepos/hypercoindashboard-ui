...
const KREDSDAO = () => {
  return (
    <div style={{ padding: 20 }}>
      <h2>KREDS DAO Control Center</h2>
      <p>This page allows DAO administrative logic via executeTask API.</p>
      <p>Use DAO Template Panel for advanced interaction.</p>
    </div>
  );
};

export default KREDSDAO;
