    ...
    const fetchStats = async () => {
      ...
      try {
        const [
          ...
          contract.totalBurned?.() || ethers.BigNumber.from("0"),
          contract.totalWallets?.() || ethers.BigNumber.from("0"),
          contract.getActiveProposalCount?.() || 0,
          contract.isFrozen?.() || false,
          contract.treasuryBalance?.() || ethers.BigNumber.from("0"),
        ]);
